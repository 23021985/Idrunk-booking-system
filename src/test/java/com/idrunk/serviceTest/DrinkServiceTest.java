...
//import com.idrunk.services.RequestServiceImpl;
...
//        RequestServiceImpl.addDrink(initialDrink);
//        verify(drinkRepository).save(drinkCaptor.capture());
//        Drink newDrink = drinkCaptor.getValue();
//        assertThat(initialDrink.getId().equals(newDrink.getId()));
//
//    }
//
//    @Test
...
//        Drink drink = new Drink();
//        drink.setId(1L);
//        drink.setRequestId(1L);
//        drinkServiceImpl.removeDrink();
//        verify(drinkRepository).deleteById(drink.getId());
//    }
//
//    @Test
