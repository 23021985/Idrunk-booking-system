...
import com.idrunk.services.UserServiceImpl;
...
public class UserServiceImplTest {
    ...
    public void getAllUsersTest() {
        ...
        List<User> userList = (List<User>) userServiceImpl.getUsers();
    ...
    public void updateUserTest() {
        ...
        initialUser.setUsername("Minion");
        initialUser.setPassword("abcd1234");
        User update = new User();
        update.setUsername("Franco");
